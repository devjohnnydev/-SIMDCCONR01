    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_color', models.CharField(default='#2563EB', max_length=7, verbose_name='Cor Primári' + 'a')),
                ('secondary_color', models.CharField(default='#0D9488', max_length=7, verbose_name='Cor Secundári' + 'a')),
                ...
                ('hero_subtitle', models.TextField(default='O sistema mais completo do Brasil para diagnóstico de riscos psicossociais, compliance NR-1, NR-17 e NR-12 — com 160 questões validadas e inteligência artificial.', verbose_name='Subtítulo do Hero')),
                ...
                ('enterprise_contact', models.EmailField(default='contato@simdcconr01.com.br', max_length=254, verbose_name='Email Enterprise')),
